                ...
                <div class="drop-file" id="banner1">
                    ...
                    @if(sizeof($content) > 0)
                        ...
                        <div class="overlay">
                            ...
                            <input type="file" id="update1" name="filename" class="input-text" style="display: none ;">
                        ...
                        <img src="{{ $content[1]->content }}" style="height: 100%; width: 405.38px">
                            <form action="/admin/content/{{ $content[1]->id }}" method="post">
                                ...
                                <div class="overlay">
                                    ...
                                    <input type="file" id="update2" name="filename" class="input-text" style="display: none ;">
                                    <button type="submit" class="btn btn-danger ms-2" style="margin-top: 25%;"><i
                                            class="fa-solid fa-trash-can"></i></button>
                                </div>
                            </form>
                        ...
                        <img src="{{ $content[2]->content }}" style="height: 100%; width: 405.38px">
                            <form action="/admin/content/{{ $content[2]->id }}" method="post">
                                ...
                                <div class="overlay">
                                    ...
                                    <input type="file" id="update3" name="filename" class="input-text" style="display: none ;">
                                    <button type="submit" class="btn btn-danger ms-2" style="margin-top: 25%;"><i
                                            class="fa-solid fa-trash-can"></i></button>
                                </div>
                            </form>
                            ...
                            @if(sizeof($ads) > 0)
                                <img class="image" src="{{ $ads[0]->content }}" style="height: 100%; width: 405.38px">
                                    <form action="/admin/content/{{ $content[0]->id }}" method="post">
                                        ...
                                        @method('DELETE')
                                        <div class="overlay">
                                            <label for="update4" class="btn btn-edit text-white" style="margin-top: 25%;"><i
                                                    class="fa-solid fa-pen-to-square text-white"></i> Ubah Gambar
                                            </label>
                                            <input type="file" id="update4" name="filename" class="input-text" style="display: none ;">
                                            <button type="submit" class="btn btn-danger ms-2" style="margin-top: 25%;"><i
                                                    class="fa-solid fa-trash-can"></i></button>
                                        </div>
                                    </form>
                            ...
                            @if(sizeof($ads) > 1)
                                <img src="{{ $ads[1]->content }}" style="height: 100%; width: 405.38px">
                                    <form action="/admin/content/{{ $content[1]->id }}" method="post">
                                        ...
                                        @method('DELETE')
                                        <div class="overlay">
                                            <label for="update5" class="btn btn-edit text-white" style="margin-top: 25%;"><i
                                                    class="fa-solid fa-pen-to-square text-white"></i> Ubah Gambar
                                            </label>
                                            <input type="file" id="update5" name="filename" class="input-text" style="display: none ;">
                                            <button type="submit" class="btn btn-danger ms-2" style="margin-top: 25%;"><i
                                                    class="fa-solid fa-trash-can"></i></button>
                                        </div>
                                    </form>
                            ...
                            @if(sizeof($ads) > 2)
                                <img src="{{ $ads[2]->content }}" style="height: 100%; width: 405.38px">
                                    <form action="/admin/content/{{ $content[2]->id }}" method="post">
                                        ...
                                        @method('DELETE')
                                        <div class="overlay">
                                            <label for="update6" class="btn btn-edit text-white" style="margin-top: 25%;"><i
                                                    class="fa-solid fa-pen-to-square text-white"></i> Ubah Gambar
                                            </label>
                                            <input type="file" id="update6" name="filename" class="input-text" style="display: none ;">
                                            <button type="submit" class="btn btn-danger ms-2" style="margin-top: 25%;"><i
                                                    class="fa-solid fa-trash-can"></i></button>
                                        </div>
                                    </form>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        {{--        uploadImage('update' + i, '#banner' + i, function () {--}}
        {{--            if({{ $content }}){--}}
        {{--                if({{ $content[0] }}.length > 0){--}}
        {{--                    return {{ $content[0]->id }}--}}
        {{--                }else if({{ $content[1] }}.length > 1){--}}
        {{--                    return {{ $content[1]->id }}--}}
        {{--                }else if({{ $content[2] }}.length > 2){--}}
        {{--                    return {{ $content[2]->id }}--}}
        {{--                }--}}
        {{--            }else if({{ $ads }}){--}}
        {{--                if({{ $ads[0] }}.length > 0){--}}
        {{--                    return {{ $ads[0]->id }}--}}
        {{--                }else if({{ $ads[1] }}.length > 1){--}}
        {{--                    return {{ $ads[1]->id }}--}}
        {{--                }else if({{ $ads[2] }}.length > 2){--}}
        {{--                    return {{ $ads[2]->id }}--}}
        {{--                }--}}
        {{--            }--}}
        {{--        })--}}
