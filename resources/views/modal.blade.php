    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="border: none;">
                <button type="button" class="btn justify-content-center w-100 py-3 text-white" style="background-color: #02182B;border-radius: 8px;">Buat Catatan</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="modal-note" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="border: none;">
                <button type="button" class="btn py-3 text-white" style="background-color: #02182B;border-radius: 8px;">Simpan</button>
