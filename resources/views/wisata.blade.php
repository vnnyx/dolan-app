                        ...
                        @if(sizeof($content) < 1) <span class="btn-file">Pilih file</span>
                            ...
                            <div class="overlay">
                                ...
                                <a data-id="{{$content[0]->id}}" class="btn btn-danger ms-2 delete"
                                    style="margin-top: 21%; color: white"><i class="fa-solid fa-trash-can"></i></a>
                            </div>
                            @endif
                    </div>
                ...
                <form action="/pengelola/data-wisata" method="post">
                    ...
                    <div class="row mb-5">
                        <div class="col-md-12">
                            ...
                            <div class="row mb-3 ml-3">
                                ...
                                <div class="col-sm-4">
                                    <input data-type="Harga Tiket" data-datas="{{ $wisata[0]->harga_tiket }}"
                                        value="{{ $wisata[0]->harga_tiket }}" type="text" class="form-control"
                                        name="harga_tiket" id="harga-tiket" placeholder="Masukkan harga tiket disini..">
                            ...
                            <div class="row mb-3 ml-3">
                                ...
                                <div class="col-sm-4">
                                    <input data-type="Stok Tiket" data-datas="{{ $wisata[0]->stock_tiket }}"
                                        value="{{ $wisata[0]->stock_tiket }}" type="text" class="form-control"
                                        name="stock_tiket" id="stok-tiket" placeholder="Masukkan stok tiket disini..">
                            ...
                            @csrf
                            @method('PUT')
                            <button type="submit" disabled id="save" class="btn btn-success"
                                style="margin-left:220px;"><i class='bx bx-check-circle'></i> Simpan Perubahan
                            </button>
                        </div>
                    </div>
                </form>
